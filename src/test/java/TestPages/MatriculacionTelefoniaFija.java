...
public class MatriculacionTelefoniaFija {
    public MatriculacionTelefoniaFija() {PageFactory.initElements(Util.driver, this);}
    ...
    @FindBy(xpath="//option[. = 'Telefonía fija']")
    ...
    public void Seleccionar_Telefono()
    {
        OpcionTelefono.click();
        String actual = OpcionTelefono.getText();
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se seleccione el tipo TELEFONIA FIJA", actual,"Telefonía fija", true, "N");
    }
    ...
    public void Seleccionar_Empresa(String dato)
    {
        ...
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se seleccione el tipo TELEFONIA FIJA", actual,dato, false, "N");
        OpcionEmpresa.click();
    }

    public void IngresarRegional(String dato) {
        Regional.click();
        Regional.sendKeys(dato);
        Util.CapturarImagen();
        Util.AvanzarPagina();
    }
    ...
    public void VP_MensajeFormatoSuministro()
    {
        ...
        Util.assert_contiene("PANTALLA DE INGRESO DE DATOS", "Verificar que se muestre el mensaje de error «Campo \"Identificación\" inválido.»", actual,"Campo \"Identificación\" inválido. Ej: 0000", true, "C");
    }
    ...
    public void VP_MensajeSinAlias()
    {
        ...
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se muestre el mensaje de error «Campo \"Alias\" vacío o inválido. Favor, ingrese algún valor.»", actual,"Campo \"Alias\" vacío o inválido. Favor, ingrese algún valor.", true, "C");
    }
    ...
    public void VP_MensajeSinSuministro()
    {
        ...
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se muestre el mensaje de error «Campo \"Identificación\" vacío o inválido. Favor, ingrese algún valor.»", actual,"Campo \"Identificación\" vacío o inválido. Favor, ingrese algún valor.", true, "C");
    }
