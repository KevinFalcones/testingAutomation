...
public class ConsultaPagoIESS {
    public ConsultaPagoIESS() {
    ...
    public void CargaDatosSuministro() {
        datos = Util.getCamposDataPool(System.getProperty("user.dir")+"/archivos/dp_suministroIESS.txt", "1");
    }
    ...
    {
        BtnPagar.click();
        String actual = BtnPagar.getText();
        Util.assert_igual("INGRESO DE DATOS", "Validar el botón «Pagar» y dar click", actual,"Pagar", true, "N");
    }
    ...
    public void VP_mensajeErrorFormatoCodigo()
    {
        ...
        Util.assert_igual("VALIDACION DE MENSAJE DE ERROR", "Se debe mostrar el mensaje de validación «Campo \"Identificación\" inválido. Ej: 0000000000000»", actual,"Campo \"Identificación\" inválido. Ej: 0000000000000", true, "C");
    }
