...
public class MatriculacionInternet {

    public MatriculacionInternet() {
    ...
    public void Seleccionar_Internet()
    {
        OpcionInternet.click();
        String actual = OpcionInternet.getText();
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se seleccione el tipo Internet", actual,"Internet", true, "N");
    }
    ...
    public void Seleccionar_Empresa(String dato)
    {
        ...
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se seleccione el tipo Internet", actual,dato, true, "N");
        OpcionEmpresa.click();
    }
