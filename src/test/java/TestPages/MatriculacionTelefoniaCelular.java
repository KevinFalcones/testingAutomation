...
public class MatriculacionTelefoniaCelular {
    ...
    @FindBy(xpath="//option[. = 'Telefonía celular']")
    ...
    public void Seleccionar_Celular()
    {
        ...
        Util.assert_igual("PANTALLA DE INGRESO DE DATOS", "Verificar que se seleccione el tipo TELEFONIA CELULAR", actual,"Telefonía celular", true, "N");
    }
    ...
    public void VP_MensajeFormatoSuministro()
    {
        ...
        Util.assert_contiene("PANTALLA DE INGRESO DE DATOS", "Verificar que se muestre el mensaje de error «Campo \"Identificación\" inválido. Ej: 0000000000»", actual,"Campo \"Identificación\" inválido. Ej: 0000000000", true, "C");
    }
